...
class Circuit
{
  ...
  public:
    ...
    int createABSModule(const string &input, const string &output, unsigned int numBits);
    ...
    int createABSMIN9X12YModule(const string &input1, const string &input2, const string &output);
};
